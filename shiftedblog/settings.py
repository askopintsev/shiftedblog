...
if DJANGO_CSP_AVAILABLE:
    ...
    _MIDDLEWARE.insert(2, 'shiftedblog.security_headers_middleware.PermissionsPolicyMiddleware')
else:
    _MIDDLEWARE.insert(1, 'shiftedblog.security_headers_middleware.SecurityHeadersMiddleware')
