...
Настройки сайта (название, соцсети, email и т.д.) меняются в двух местах:

- **Интерфейс редактора** → Настройки → **Сайт**
- **Панель администратора** → **Core → Site settings**

Изменения появляются на сайте сразу, без переустановки.
